...
<div align=center>
  <img src="./assets/binary_single.png" width="40%" height="40%"/>
</div>
...
<div align=center>
  <img src="./assets/binary_repo.png" width="40%" height="40%"/>
</div>
...
<div align=center>
  <img src="./assets/binary_GRU_single.png" width="40%" height="40%"/>
</div>
The evaluation result is shown below.
...
<div align=center>
  <img src="./assets/binary_GRU_repo.png" width="40%" height="40%"/>
</div>
...
However, the performance of No. 3 is close to No. 1 and No. 2 by using ```mean embedding```  strategy, but No. 3 takes lots of training time. More details of the training process and evaluation process can be found in the [sequential/sequentail_trainer.ipynb](https://github.com/RepoMining/SimilarityCal/blob/main/sequential/sequential_trainer.ipynb) file.
